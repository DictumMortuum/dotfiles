...
config.bind('<Ctrl-Shift-b>', exec_userscript('qute-bookmark-save'))
config.bind('<Ctrl-b>', exec_userscript('qute-bookmark-open'))
...
c.colors.tabs.pinned.selected.even.bg = xresources["*color8"]
c.colors.tabs.pinned.selected.even.fg = xresources["*color7"]
c.colors.tabs.pinned.selected.odd.bg = xresources["*color8"]
c.colors.tabs.pinned.selected.odd.fg = xresources["*color7"]
